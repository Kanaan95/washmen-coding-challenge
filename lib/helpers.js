...
// Cache for great-circle distance results to avoid redundant calculations
const distanceCache = {};
...
helpers.getGreatCircleDist = (P1, P2, unit) => {
  ...
  P1 = typeof P1 == "object" && P1 !== null ? P1 : false;
  P2 = typeof P2 == "object" && P2 !== null ? P2 : false;

  if (P1 && P2) {
    // Return cached result if available
    const cacheKey = `${P1.lat},${P1.long}|${P2.lat},${P2.long}|${unit}`;
